...
- [x] **[중요] 객체 슬라이싱(Object Slicing)**: 다형성 객체 복사 금지 원칙과 메모리 파괴 방지 ([concept](cpp_basics/module_07/concept_object_slicing.md))
...
- [x] **Selector 모델 (비동기 처리 기초)**: `select()` 함수를 활용한 Non-blocking 다중 I/O 처리 맛보기. ([concept](cpp_basics/module_13/concept_selector_model.md), [practice](cpp_basics/module_13/practice_select_server.cpp))
